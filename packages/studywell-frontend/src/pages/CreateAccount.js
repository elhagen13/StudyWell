...
function CreateAccount() {
    ...
    function accountCreation() {
        ...
        fetchUserByUsername(username.value).then((res) => {
    ...
    return ( 
        <div className = "createTotalPage">
            <div className = "createAccount">
                ...
                <form className="form">
                    <label for="username" className = "createSmall">username</label>
                    <input type="text" id="username" className = "createField"/>
                    {usernameExistence && <div className = "createIncorrect">USERNAME TAKEN</div>}
                    <label for="email" className = "createSmall">email</label>
                    <input type="text" id="email" className = "createField"/>
                    {emailExistence && <div className = "createIncorrect">ACCOUNT ALREADY EXISTS FOR GIVEN EMAIL</div>}
                    <label for="password" className = "createSmall">password</label>
                    <input type="text" id="password" className = "createField"/>
                    <input type="button" className="create_submit_info" value="Create Account" onClick={accountCreation} />
                </form>
            </div>
        </div>
